...
export default function Kurumsal() {
  ...
  const h1s = { fontSize: 'clamp(32px,5vw,48px)', fontWeight: 800, letterSpacing: -1.5, color: '#f8f9fb', marginBottom: 24, lineHeight: 1.1 }
      ...
      <div style={wrap}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 24, marginBottom: 60 }}>
          <div style={{ ...card, background: 'rgba(99,102,241,.08)', border: '1px solid rgba(99,102,241,.15)' }}>
            ...
            <h2 style={{ fontSize: 22, fontWeight: 800, color: '#f8f9fb', marginBottom: 14 }}>Sektörde Uzman Kuruluş</h2>
          ...
          <div style={{ ...card, background: 'rgba(52,211,153,.06)', border: '1px solid rgba(52,211,153,.12)' }}>
            ...
            <h2 style={{ fontSize: 22, fontWeight: 800, color: '#f8f9fb', marginBottom: 14 }}>Etik ve Güvenilir Hizmet</h2>
        ...
        <div style={{ marginBottom: 48 }}>
          <h2 style={{ fontSize: 28, fontWeight: 800, color: '#f8f9fb', marginBottom: 20, letterSpacing: -0.5 }}>Hedeflerimiz</h2>
        ...
        {/* Değerler */}
        <div>
          <h2 style={{ fontSize: 28, fontWeight: 800, color: '#f8f9fb', marginBottom: 20, letterSpacing: -0.5 }}>Değerlerimiz</h2>
          <div style={{ background: '#ffffff', border: '1px solid #e8e8ed', borderRadius: 16, padding: 28 }}>
